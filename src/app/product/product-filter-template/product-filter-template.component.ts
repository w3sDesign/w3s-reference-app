...
@Component({
  selector: 'w3s-product-filter-template',
  templateUrl: './product-filter-template.component.html',
  styleUrls: ['./product-filter-template.component.scss']
})
...
export class ProductFilterTemplateComponent implements OnInit, AfterViewInit, OnChanges {
  ...
  /**
   * Automatically generated from existing product questions.
   */
  ...
  // activatedFilterTemplate: ProductFilterTemplate;
  ...
  constructor(
    private productFTService: ProductFilterTemplateService,
  ...
  ngAfterViewInit() {
    ...
    this.productFTService.getProductFilterTemplates()
      .subscribe(
        res => {
    ...
    dialogRef.afterClosed()
      .subscribe(
        name => {
          ...
          this.productFTService.createProductFilterTemplate(filterTemplate)
            .subscribe(
              () => {
                this.productFTService.getProductFilterTemplates()
                  .subscribe(
                    ...
                    // err handled in productFTService
                  );
              }
            );
        }
  ...
  onFilterSelectionChange(name: string) {
    ...
    // analog this.productForm.form.patchValue(this.product);
  ...
  setDisplayedFilterNames(filterTemplate: ProductFilterTemplate) {
  ...
  updateFilterTemplate(filterTemplate: ProductFilterTemplate) {
    ...
    this.productFTService.updateProductFilterTemplate(filterTemplate)
      .subscribe(
        () => {
  ...
  private logMessage(message: string) {
    return this.messageService.logMessage('[product-filter-template.component.ts] ' + message);
  }
